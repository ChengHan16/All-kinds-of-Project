...
win.iconphoto(True, tk.PhotoImage(file='E:/Python Project/Download mp3 Project/pytube-11.0.2/youtube.png')) # Title icon圖片設定 & 存放位置
#------------ Label：顯示圖片 ------------#
img=Image.open('E:/Python Project/Download mp3 Project/pytube-11.0.2/youtube.png')  # 開啟圖片位置
